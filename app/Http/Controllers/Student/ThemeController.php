...
class ThemeController extends Controller
{
    ...
    {
        $themes = Theme::where('sent_by',Auth::user()->id)->get();
        // dd($themes);
        return view('student.theme.index',compact('themes'));
    }

    public function show(Request $request,$id)
    {
        $theme = Theme::where('id',$id)->where('sent_by',Auth::user()->id)->firstorfail();
        // dd($themes);
        return view('student.theme.show',compact('theme'));
    }
