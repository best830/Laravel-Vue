                  ...
                  <tbody>
                        @foreach($themes as $theme)
                            <tr>
                                ...
                                <td>   
                                  <a href="{{ route('student.theme.show',[ 'id' => $theme->id ]) }}" class="btn btn-icon btn-xs waves-effect waves-light btn-info"> <i class="fa fa-eye"></i> </a>                                 
                                    {{-- <a href="{{ route('admin.theme.edit',[ 'id' => $theme->id ]) }}" class="btn btn-icon btn-xs waves-effect waves-light btn-info"> <i class="fa fa-pencil"></i> </a> --}}
