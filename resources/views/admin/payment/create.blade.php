            ...
            <div class="col-md-12">
                <section class="content">
                    <div class="box box-primary">
                        ...
                        <!-- /.box-header -->
                        <!-- form start -->
                        <form role="form" action="{{ route('admin.payment.store') }}" method="POST">
                            @csrf
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="box-body">
                                    ...
                                    <div id="domains">
                                        <div class="box-body">
                                            <div class="form-group" style="border: 1px solid #e0e0e0;padding:10px;">
                                                ...
                                                <input type="number" class="form-control" id="no_of_meditations" placeholder="Enter No of Meditations" name="no_of_meditations[]">
                                            </div>
                                        </div>
                                    </div>                                    
